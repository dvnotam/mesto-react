...
function PopupAvatarForm (props) {
    ...
    return (
        <PopupWithForm name='avatar-profile' title='Обновить Аватар' buttonSubmit='Сохранить' onSubmite={handleSubmit} isLoading={props.isLoading} isOpenPopup={props.isOpen} onClosePopup={props.onClose}>
